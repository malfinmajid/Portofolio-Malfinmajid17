...
import { Briefcase, Target, Globe, NotebookPen, Zap, ChevronLeft, ChevronRight, Presentation } from "lucide-react";
...
const Projects = () => {
    ...
    // Categories icons maping
    const categoryIcons = {
        'All': Target,
        'Web Apps': Globe,
        'Document Test': NotebookPen,
        'API Test': Zap,
    };

    return (
        <section id="projects" className="relative pt-5 py-20 bg-black overflow-hidden">
            <div className="absolute inset-0 overflow-hidden">
                ...
                <div className="absolute top-1/2 right-0 w-96 h-96 bg-primary/10 opacity-20 rounded-full blur-3xl" />
            </div>
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <FadeIn delay={0}>
                    <div className="text-center mb-12">
                        ...
                        {/* <p className="text-lg text-white/60 max-w-2xl mx-auto">Showing my project results</p> */}
                        ...
                        <div className="overflow-x-auto scroll-smooth snap-x snap-mandatory hide-scrollbar" 
                            ...
                            <div className="flex gap-6 pb-4">
                                {filteredProjects.map((project) => (
                                    <div className="w-full md:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)] shrink-0 snap-start" 
                                        key={project.id}>
